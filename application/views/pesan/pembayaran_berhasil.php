                        ...
                        <form action="<?= base_url('pesan/uploadBuktiPembayaran'); ?>" method="post" enctype="multipart/form-data" class="wrapper d-flex align-items-center">
                            ...
                            <div class="row button-row align-items-center">
                                <div class="form-group col-sm-6">
                                    <button type="submit" class="btn btn-block custom-btn">Upload</button>
                                </div>
                                <div class="form-group col-sm-6">
                                    <button type="button" class="btn btn-block custom-btn" onclick="window.location.href='<?= base_url('pesan/exportToPdf/' . $id_pesan); ?>'">Bayar</button>
                                </div>
                            </div>
                        </form>
                    </div>
