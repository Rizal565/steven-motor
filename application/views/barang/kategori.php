...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <?php } ?>
            <?= $this->session->flashdata('pesan'); ?>
            <a href="" class="btn btn-danger mb-3" data-toggle="modal" data-target="#kategoriBaruModal"><i class="fas fa-plus"></i> Tambah Kategori</a>
                ...
                <tbody>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td><?= $k['kategori']; ?></td>
                            <td>
                                <a href="<?= base_url('barang/ubahkategori/') . $k['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
                                <a href="<?= base_url('barang/hapuskategori/') . $k['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['kategori']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
